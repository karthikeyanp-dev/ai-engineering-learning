# Best YouTube Channels & Playlists for AI Engineering

## Foundational / Must-Subscribe

### 1. Andrej Karpathy
- **Channel:** https://www.youtube.com/@AndrejKarpathy
- Neural Networks: Zero to Hero playlist
- "Let's build GPT from scratch", "State of GPT"

### 2. 3Blue1Brown
- **Channel:** https://www.youtube.com/@3blue1brown
- Neural Networks series, Linear Algebra series

### 3. DeepLearning.AI
- **Channel:** https://www.youtube.com/@Deeplearningai
- Short courses, Andrew Ng's lectures
...
### 4. AI Jason
- **Channel:** https://www.youtube.com/@AIJasonZ
- Practical AI agent tutorials, RAG implementations
...
### 7. Sam Witteveen
- **Channel:** https://www.youtube.com/@samwitteveen
- LangChain, RAG, agent tutorials

### 8. James Briggs
- **Channel:** https://www.youtube.com/@jamesbriggs
...
- **FreeCodeCamp AI courses** (various)
